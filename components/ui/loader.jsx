...
export const LoaderOne = () => {
  ...
  return (
    <div className="flex items-center gap-4 w-full h-screen justify-center bg-gray-300">
      <motion.div
        initial={{
          y: 0,
        }}
        ...
        className="h-18 w-8 rounded-full border border-neutral-300 bg-linear-to-b from-neutral-400 to-neutral-300" />
      <motion.div
        initial={{
          y: 0,
        }}
